          ...
          <tbody>
            ...
            {claims.map((c: any) => (
              <tr key={c.id}>
                ...
                <td className="font-medium max-w-48 truncate">{c.title}</td>
                ...
                <td className="text-right"><Link href={`/app/my-claims/${c.id}`}><Button size="sm" variant="outline">Track <ChevronRight className="h-3.5 w-3.5 ml-0.5" /></Button></Link></td>
              </tr>
            ))}
          </tbody>
        </table>
