        ...
        <div className="hidden lg:flex relative overflow-hidden bg-gradient-to-br from-primary via-primary/95 to-primary/90">
          ...
          <div className="relative z-10 flex flex-col justify-between p-12 text-white">
            ...
            <div className="text-sm text-white/40">
              &copy; {new Date().getFullYear()} Designed & Developed by <a href="https://synergyinterface.com/web/" target="_blank" rel="noopener noreferrer" className="underline hover:text-white/70 transition-colors">Synergy Interface Ltd</a>. All rights reserved.
            </div>
          </div>
        </div>
